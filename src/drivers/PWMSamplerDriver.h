...
//                                     |
//=============================================================================
#ifndef PWM_SAMPLER_DRIVER_HPP
#define PWM_SAMPLER_DRIVER_HPP

#include <FspTimer.h>      // Timer Support
#include "SMAController.hpp"

class SMAController; // Forward declaration
using SMAController_Callback = void(*)(SMAController *);

class PWMSamplerDriver {
    public:
        PWMSamplerDriver(float frequency, float startDuty, int _pwm_pin, int _measure_delay, int _cycle_threshold, SMAController_Callback _measureFunc, SMAController *_instance);
        ~PWMSamplerDriver();
    ...
    private:
        ...
        int pwm_pin;
        SMAController_Callback measureFunc;

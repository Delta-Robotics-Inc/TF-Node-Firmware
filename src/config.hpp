...
const char CFG_FIRMWARE_VERSION[] = "1.0.2";  // Increment before pull request to main branch
const int CFG_FIRMWARE_VERSION_MAJOR = 1;
const int CFG_FIRMWARE_VERSION_MINOR = 0;
const int CFG_FIRMWARE_VERSION_PATCH = 2;
